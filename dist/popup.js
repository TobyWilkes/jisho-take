...
__WEBPACK_IMPORTED_MODULE_0_jquery__(function () {
    ...
    function displayWords() {
        ...
        output += `</div>`;
        __WEBPACK_IMPORTED_MODULE_0_jquery__('#output').html(output);
        // Add behaviour for delete button
        __WEBPACK_IMPORTED_MODULE_0_jquery__('.word__delete').click(function (e) {
            list.removeByIndex(__WEBPACK_IMPORTED_MODULE_0_jquery__(this).data("index"));
            list.save();
            displayWords();
        ...
        __WEBPACK_IMPORTED_MODULE_0_jquery__('#export-all').attr("href", URL.createObjectURL(data));
        __WEBPACK_IMPORTED_MODULE_0_jquery__('#export-all').attr("download", `${(new Date().toLocaleTimeString())}-${list.words.length}-words.csv`);
    }
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery__('#remove-all').click(function (e) {
