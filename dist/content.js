...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__WordList__ = __webpack_require__(1);



__WEBPACK_IMPORTED_MODULE_0_jquery__("document").ready((e) => {
    let connection = browser.runtime.connect();
    let linkNodes = document.querySelectorAll(".concept_light-status_link[data-dropdown]");
    let list = new __WEBPACK_IMPORTED_MODULE_2__WordList__["a" /* WordList */]();
    let addLibraryNodes = [];
    ...
    __WEBPACK_IMPORTED_MODULE_0_jquery__("a[data-word]").click(function (e) {
        let root = __WEBPACK_IMPORTED_MODULE_0_jquery__(this).parents(".concept_light");
        let d = new __WEBPACK_IMPORTED_MODULE_1__Definition__["a" /* Definition */]();
        let definitionNodes = __WEBPACK_IMPORTED_MODULE_0_jquery__(root).find(".meanings-wrapper .meaning-meaning, .meanings-wrapper .meaning-tags");
        let definitions = [];
        for (let node of definitionNodes) {
            definitions.push(node.innerText.trim() + "\n");
        }
        d.left = [__WEBPACK_IMPORTED_MODULE_0_jquery__(root).find(".concept_light-representation .text").text().trim(), __WEBPACK_IMPORTED_MODULE_0_jquery__(root).find(".concept_light-representation .furigana").text().trim()];
        d.right = definitions;
